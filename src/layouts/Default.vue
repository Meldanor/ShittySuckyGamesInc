<template>
  <div class="h-full">
    <header>
      <div class="pt-4 mx-auto w-full">
        <h1 class="pb-4 text-center underline md:text-5xl text-3xl font-bold font-mono italic tracking-tight">
          Shitty Sucky Games Inc.
        </h1>
        <div class="pb-8 mx-auto flex flex-row justify-center gap-4 text-lg underline font-semibold text-gray-900">
          <g-link class="hover:text-black" to="/">Games</g-link>
          <g-link class="hover:text-black" to="/inputs/">Einreichungen</g-link>
          <g-link class="hover:text-black" to="/about/">About</g-link>
        </div>
      </div>
    </header>
    <slot/>
